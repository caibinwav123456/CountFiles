...
#define DEF_PROP_TABSL_RECT    CRect(-31,1,-17,15)
#define DEF_PROP_TABSR_RECT    CRect(-15,1,-1,15)
...
#define PROP_TABSL_RECT    DEF_PROP_TABSL_RECT
#define PROP_TABSR_RECT    DEF_PROP_TABSR_RECT
...
#define PROP_TABSL_RECT    (CProgramData::GetRealRect(DEF_PROP_TABSL_RECT))
#define PROP_TABSR_RECT    (CProgramData::GetRealRect(DEF_PROP_TABSR_RECT))
